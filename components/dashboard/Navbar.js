...
const Navbar = () => {
  ...
  return (
    <div className={`flex flex-col md:flex-row gap-2 justify-between items-center py-4 ${bar ? "overflow-y-hidden" : ""}`}>
      {/* Mobile Sidebar */}
      ...
      <div className="flex md:flex-row flex-col md:w-full items-center justify-between gap-4">
        {/* Search Bar */}
